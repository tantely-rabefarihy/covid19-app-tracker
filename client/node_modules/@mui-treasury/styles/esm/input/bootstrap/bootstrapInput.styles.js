  ...
  return {
    root: {
      '&.-valid $input': {
        ...
        '&:focus': {
          boxShadow: "0 0 0 0.2rem ".concat(Color(validColor).fade(0.75))
        }
      }
    },
    error: {
      '& $input': {
        ...
        '&:focus': {
          boxShadow: "0 0 0 0.2rem ".concat(Color(errorColor).fade(0.75))
        }
      }
    },
    input: {
      ...
      '&:focus': {
        ...
        boxShadow: "0 0 0 0.2rem ".concat(Color(normalColor).fade(palette.type === 'dark' ? 0.48 : 0.75))
      }
    }
  };
});