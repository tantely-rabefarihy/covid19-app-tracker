...
export default function defaultStyles(_ref) {
  ...
  return createStyles({
    ...
    input: {
      ...
      '&:hover, &:focus': {
        borderColor: palette.type === 'dark' ? palette.text.secondary : palette.primary.main,
        boxShadow: "inset 0 0 0 1px ".concat(palette.type === 'dark' ? palette.text.secondary : palette.primary.main),
